    ...
    <section className="business">
      <div className="business__container section-container">
        <div className="business__img business__img--1">
          <Image
            src="https://images.unsplash.com/photo-1528467279403-46af96c37ab3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cGxhbnQlMjBjYXJlfGVufDB8MXwwfHw%3D&auto=format&fit=crop&w=2000&q=80"
        ...
        <div className="business__img business__img--2">
          <Image
            ...
            alt="decorative place with plants"
            width={420}
            height={350}
          />
        </div>
        ...
        <div className="business__img business__img--3">
          <Image
            src="https://images.unsplash.com/photo-1492201794891-32eece378309?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTZ8fGhvdXNlcGxhbnR8ZW58MHwwfDB8fA%3D%3D&auto=format&fit=crop&w=2000&q=80"
